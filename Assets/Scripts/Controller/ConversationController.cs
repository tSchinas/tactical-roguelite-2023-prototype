...
public class ConversationController : MonoBehaviour
{
    ...
    Canvas canvas;//for disabling/enabling for performance
    IEnumerator conversation;//steps through all speakers and messages in convo
    Tweener transition;//animate panel into/out of screen, disallow advancing of conversation during transition
