...
public class LayoutAnchor : MonoBehaviour
{
    ...
    Vector2 GetPosition (RectTransform rt, TextAnchor anchor)
    {
        ...
        //allow cases to fall through until break is reached
        //i.e any vertical center anchor settings will modify return x by half
        //i.e any vertical right anchor settings will modify return x by value, etc.
        switch (anchor) 
        {
